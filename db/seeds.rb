...
@vp4 = ViewingParty.create!(movie_id: 114, duration: 154, date: Time.new(2022, 04, 13, 19, 30), start_time: Time.new(2022, 04, 13, 19, 30))
@vp5 = ViewingParty.create!(movie_id: 115, duration: 155, date: Time.new(2022, 04, 15, 19, 00), start_time: Time.new(2022, 04, 15, 19, 00))
@vp6 = ViewingParty.create!(movie_id: 116, duration: 156, date: Time.new(2022, 04, 16, 19, 00), start_time: Time.new(2022, 04, 15, 19, 00))
@vp7 = ViewingParty.create!(movie_id: 117, duration: 157, date: Time.new(2022, 04, 10, 18, 30), start_time: Time.new(2022, 04, 10, 18, 30))
@vp8 = ViewingParty.create!(movie_id: 118, duration: 158, date: Time.new(2022, 04, 9, 18, 00), start_time: Time.new(2022, 04, 9, 18, 00))
@vp9 = ViewingParty.create!(movie_id: 119, duration: 159, date: Time.new(2022, 04, 18, 17, 30), start_time: Time.new(2022, 04, 18, 17, 30))
@vp10 = ViewingParty.create!(movie_id: 120, duration: 161, date: Time.new(2022, 04, 21, 17, 00), start_time: Time.new(2022, 04, 21, 17, 00))
