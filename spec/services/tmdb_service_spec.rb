...
RSpec.describe TmdbService do
  ...
  it 'establishes a connection for top rated movies' do 
  ...
  it 'establishes a connection for reviews' do    
  ...
  it 'establishes a connection for details' do 
  ...
  it 'establishes a connection for credits' do 
