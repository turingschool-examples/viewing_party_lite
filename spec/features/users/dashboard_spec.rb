...
RSpec.describe 'User Dashboard Page' do
  before :each do
    ...
    @party1 = ViewingParty.create(movie_title: 'Fellowship of the Ring', length: 200, start_time: '03:45', date: '2022-12-23')
    @party2 = ViewingParty.create(movie_title: 'Psych the Movie', length: 150, start_time: '18:45', date: '2022-11-23')
