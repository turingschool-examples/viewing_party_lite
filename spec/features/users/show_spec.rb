...
RSpec.describe "the User Show page aka the user's dashboard" do
  describe "when a user visits '/users/:id' where id is a valid user id" do
    it "shows '<user name>'s Dashboard', a Discover Movies button, and a list of that user's viewing parties", :vcr do
      user = User.create!(name: 'Amanda', email: 'amanda@turing.edu', password: 'amanda',
      ...
      party_1 = ViewingParty.create!(movie_id: 129, movie_title: 'Spirited Away', duration: 180, date: '2022-12-12',
                                     start_time: '17:00', run_time: 150)
      party_2 = ViewingParty.create!(movie_id: 680, movie_title: 'Pulp Fiction', duration: 200, date: '2022-12-13',
                                     start_time: '19:00', run_time: 150)
