...
save_and_open_page
      ...
      within "#viewing-party-#{party_1.id}" do 
        expect(page).to have_link("The Princess Bride", href: user_movie_path(user, party_1.movie_id))
      ...
      within "#viewing-party-#{party_2.id}" do 
        expect(page).to have_link("Jurassic Park", href: user_movie_path(user, party_2.movie_id))
