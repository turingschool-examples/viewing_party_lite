...
RSpec.describe 'Movies Index' do
  ...
  it 'only returns movies that meet the criteria, and responses are case insensitive' do
    ...
    stub_request(:get, "https://api.themoviedb.org/3/search/movie?api_key=2f8f6c343a2a2acbd770dfbfbb00e38a&language=en-US&query=the%20grand%20budapest%20hotel&page=1&include_adult=false").
      to_return(status: 200, body: json_response)
