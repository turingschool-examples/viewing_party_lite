...
RSpec.describe 'User Registration Page' do
  describe 'As a user' do
    describe "When a user visits the '/register' path" do
      it 'They should see a form to register. The form should include: Name, Email, Register Button, once the user registers they should be taken to a dashboard page /users/:id' do
        visit '/register'
      ...
      it 'The email must be unique' do
        ...
        User.create!(name: 'Janny', email: 'Jane.doe@aol.com')
