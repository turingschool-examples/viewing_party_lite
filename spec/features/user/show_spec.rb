...
RSpec.describe 'the user show page' do
  before :each do
    ...
    @party_1 = @mostafa.parties.create!(movie_title: "The Godfather", duration: 175, date: "12/1/2022", time: "19:00", host_id: @mostafa.id)
    @party_2 = @mostafa.parties.create!(movie_title: "Young Adam", duration: 93, date: "12/4/2022", time: "18:00", host_id: @mostafa.id)
    @party_3 = @mostafa.parties.create!(movie_title: "Natural Born Killers", duration: 118, date: "12/7/2022", time: "20:00", host_id: @mostafa.id)
    @party_4 = @yuji.parties.create!(movie_title: "Pulp Fiction", duration: 154, date: "12/8/2022", time: "19:30", host_id: @yuji.id)
    @party_5 = @bryan.parties.create!(movie_title: "Up", duration: 96, date: "12/8/2022", time: "17:00", host_id: @bryan.id)
  ...
  it "has a section for the user's hosted parties with information on each party" do
    ...
    within '#hosted_parties' do
      within '#The Godfather' do
        ...
        expect(page).to have_content("Date: 12/1/2022")
