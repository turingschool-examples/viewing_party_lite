...
RSpec.describe "New User", type: :feature do
  ...
  expect(page).to_have content("Shawshank Redemption")
  expect(page).to_have content("Vote Average: 8.7")
  expect(page).to_have content("Dilwale Dulhania Le Jayenge")
  expect(page).to_have content("Vote Average: 8.7")
  expect(page).to_have content("The Godfather")
  expect(page).to_have content("Vote Average: 8.7")
