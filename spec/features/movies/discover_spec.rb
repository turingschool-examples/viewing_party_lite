...
RSpec.describe 'Discover Movies View Page' do
    describe 'happy path' do
        it 'allows user to search for movies' do
            ...
            stub_request(:get, "https://www.themoviedb.org/3/search/movie?api_key=#{ENV['moviedb_api_key']}&query=").to_return(status: 200, body: json_response)            user_1 = User.create!(name: "Bryan", email: "bryan@bryan.com")
