...
RSpec.describe User, type: :model do
    describe 'relationships' do
        ...
        it 'has multiple relationships with viewing party via host and invitees' do
            ...
            viewing_party_1 = ViewingParty.create!(movie_id: 12345, duration: 600, date: "2022-10-10", start_time: "16:00:00", host_id: user_1.id)
            viewing_party_2 = ViewingParty.create!(movie_id: 12345, duration: 600, date: "2022-10-10", start_time: "16:00:00", host_id: user_2.id)
